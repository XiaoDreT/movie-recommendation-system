...
Original file is located at
    https://colab.research.google.com/drive/1ynu78Bjve98TVI6vD8YbRA0JWZCm-G20
...
#### Menggabungkan dua dataset pada kolom 'id'
"""

df.columns = ['id','tittle','cast','crew']
df1 = df1.merge(df,on='id')

"""#### Mengecek data yang telah digabung"""

df1.head(5)

# Memvisualisasikan hasil dari penggabungan data
df1.columns
...
Dalam sistem rekomendasi ini, fitur film (overview, cast, crew, keyword, dll) digunakan untuk menemukan kemiripannya dengan film lain. Kemudian film yang paling mungkin mirip akan direkomendasikan.
...
Dalam sistem rekomendasi ini merekomendasikan film-film yang mirip dengan preferensi pengguna di masa lalu.
